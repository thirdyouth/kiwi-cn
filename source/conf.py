# -*- coding: utf-8 -*-
#
# openSUSE Kiwi 文档 build configuration file, created by
# sphinx-quickstart on Sat Aug  8 05:35:42 2015.
#
...
project = u'openSUSE Kiwi 文档'
copyright = u'2015, Marcus Schäfer'
...
latex_documents = [
  (master_doc, 'TsingBrick.tex', u'openSUSE Kiwi 文档',
...
man_pages = [
    (master_doc, 'tsingbrick', u'openSUSE Kiwi 文档',
     [author], 1)
]
